...
//  Coding_iOS
//
//  Created by taolei-mac on 2017/11/21.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // 2. 设置根控制器
//    TLNavigationViewController *nav = [[TLNavigationViewController alloc] initWithRootViewController:[[TLLoginViewController alloc] init]];
